...
/**
 * Tela de interface gráfica para o gerenciamento (CRUD) de Discentes.
 *
...
public class DiscenteTela extends javax.swing.JDialog {
    ...
    private void preencherFormulario() {
        ...
        dteNascimento.setDate(discenteEmEdicao.getNascimento());
    }
    ...
    private void salvarDiscente() {
        ...
        try {
            ...
            discenteEmEdicao.setNascimento(dataSelecionada);
