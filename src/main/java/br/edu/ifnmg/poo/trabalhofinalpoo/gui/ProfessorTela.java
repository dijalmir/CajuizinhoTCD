...
/**
 * Tela de interface gráfica para o gerenciamento (CRUD) de Professores.
 *
...
public class ProfessorTela extends javax.swing.JDialog {
    ...
    public ProfessorTela(java.awt.Frame parent, boolean modal) {
        ...
        DatePickerSettings settings = new DatePickerSettings(new Locale("pt", "BR"));
        settings.setFormatForDatesCommonEra("dd/MM/yyyy");
        dteNascimento.setSettings(settings);
    ...
    private void preencherFormularioComDados() {
        ...
        if (professorEmEdicao.getNascimento() != null) {
            dteNascimento.setDate(professorEmEdicao.getNascimento());
        } else {
            dteNascimento.clear();
        }
    }
    ...
    private void salvarProfessor() {
        ...
        LocalDate dataSelecionada = dteNascimento.getDate();
        ...
        try {
            ...
            professorEmEdicao.setNascimento(dataSelecionada);
    ...
    private void initComponents() {
        ...
        dteNascimento = new com.github.lgooddatepicker.components.DatePicker();
    ...
    private com.github.lgooddatepicker.components.DatePicker dteNascimento;
